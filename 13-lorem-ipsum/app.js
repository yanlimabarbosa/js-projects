...
form
  .addEventListener("submit", (e) => {
    ...
    if (isNaN(value) || value < 0) {
      result.innerHTML = `<p class="result">Please Insert a Real Number</p>`
    } else if (value === 0) {
      ...
      for (let i = 0; i < value; i++) {
        const index = i % textCount // Wrap the index within the range of available texts
        selectedParagraphs.push(text[index])
      }
      ...
      result.innerHTML = selectedParagraphs
